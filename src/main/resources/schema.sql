...
DROP TABLE IF EXISTS bus_timetabling.timetables CASCADE;
DROP TABLE IF EXISTS bus_timetabling.route_stops CASCADE;
DROP TABLE IF EXISTS bus_timetabling.buses CASCADE;
DROP TABLE IF EXISTS bus_timetabling.stops CASCADE;
DROP TABLE IF EXISTS bus_timetabling.routes CASCADE;
...
CREATE TABLE IF NOT EXISTS bus_timetabling.route_stops (
...
CREATE TABLE IF NOT EXISTS bus_timetabling.timetables (
    timetable_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    bus_id       BIGINT NOT NULL,
    stop_id      BIGINT NOT NULL,
    arrival      TIME WITHOUT TIME ZONE,
    departure    TIME WITHOUT TIME ZONE,
    CONSTRAINT pk_timetables PRIMARY KEY (timetable_id),
